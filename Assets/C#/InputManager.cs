...
public class InputManager : MonoBehaviour
{
    ...
    [SerializeField] private float rotateSensitivity = 0.1f;
    ...
    private void OnEnable()
    {
        if (inputActions == null)
        {
            ...
            // interaction map
            inputActions.Interaction.Interact.performed += i =>
            {
                InteractPressed = true;
                PlayerManager.Instance.HandleInteraction();
            };

            inputActions.Interaction.Cancel.performed += i =>
            {
                InteractPressed = false;
                PlayerManager.Instance.CancelInteraction();
            };
        }
    ...
    private void Update()
    {
        ...
        RotateInput = rotateInput * rotateSensitivity;
    }
